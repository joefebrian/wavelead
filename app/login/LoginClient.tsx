  ...
  return (
    <>
      ...
      <main className="container py-16 max-w-md">
        ...
        <h1 className="text-3xl font-bold">Sign in to WaveLead</h1>
        <p className="text-muted-foreground mt-2">Log in to your WaveLead account to manage channels, campaigns, sponsorships and marketplace activity.</p>
        <div className="mt-8">
