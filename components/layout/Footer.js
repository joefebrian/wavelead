    ...
    <footer className="border-t border-border/60 bg-background">
      <div className="container py-10 grid gap-8 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">WaveHub</span>
          </div>
      ...
      <div className="border-t border-border/60">
        <div className="container py-4 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
          <span>© {new Date().getFullYear()} WaveHub. All rights reserved.</span>
          <span>WhatsApp is a trademark of Meta Platforms, Inc. WaveHub is an independent service.</span>
        </div>
      </div>
    </footer>
  );
